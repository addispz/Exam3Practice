...
def run_test_zero_changer():
    ...
    # Test 2:
    test2 = ([8, 0, 0, 9], [0, 0, 0, 1, 5, 0], [4, 0, 4], [4, 0, 5])
    expected2 = ([8, 1, 2, 9], [3, 4, 5, 1, 5, 6], [4, 7, 4], [4, 8, 5])
    zero_changer(test2)
    print()
    print('Test 2:')
    ...
    # Test 3:
    test3 = ([], [77, 0, 0, 1, 5, 0], [0, 4, 4], [4, 0, 4])
    expected3 = ([], [77, 1, 2, 1, 5, 3], [4, 4, 4], [4, 5, 4])
    zero_changer(test3)
    print()
    print('Test 3:')
...
def zero_changer(tuple_of_lists):
    ...
    for k in range(len(tuple_of_lists)):
        current_list = tuple_of_lists[k]
        for j in range(len(current_list)):
            if current_list[j] == 0:
                current_list[j] = count
                count = count + 1
